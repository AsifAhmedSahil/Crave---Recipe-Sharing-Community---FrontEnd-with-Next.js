...
const RecipeDetails = ({ params }: { params: { recipeId: string } }) => {
  ...
  const {mutate: handleAddComment,isPending,isSuccess} = useAddComment()
  ...
  return (
    <div className="container mx-auto py-10">
      <div className=" bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold mb-4 text-black">{recipeData.title}</h1>
        <div className="flex">
        ...
        <div className="flex justify-between items-center mb-6">
          <span className="text-lg font-semibold text-black">Average Rating: {recipeData.averageRating} ★</span>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-4 mb-6">
            {recipeData.comments.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map((comment) => (
             <div key={comment._id} className="border p-4 rounded-lg text-black flex space-x-3">
